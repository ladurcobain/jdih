...
class DetailRegulation extends StatelessWidget {
  var data;
  DetailRegulation({Key? key, required this.data}) : super(key: key);
        ...
        Column(
          children: [
            ...
            Row(
              ...
              children: [
                _buildIconText(Icons.star, Colors.orange[300]!, '989k)'),
                const SizedBox(
                  width: 10,
                ),
                _buildIconText(Icons.visibility, Colors.white, '999M Read'),
              ],
            ),
            const SizedBox(
              height: 10,
